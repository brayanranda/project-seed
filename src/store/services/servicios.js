...
export const getAnalisis_SEC = async () => {
    return await (await fetch(SEED.ESTRUCTURAS_LINEALES.SECUENCIAS, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_LS = async () => {
    return await (await fetch(SEED.ESTRUCTURAS_LINEALES.LISTAS_SIMPLES, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_LD = async () => {
    return await (await fetch(SEED.ESTRUCTURAS_LINEALES.LISTAS_DOBLES, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_LCS = async () => {
    return await (await fetch(SEED.ESTRUCTURAS_LINEALES.LISTA_CIRCULARES_SIMPLES, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_LCD = async () => {
    return await (await fetch(SEED.ESTRUCTURAS_LINEALES.LISTA_CIRCULARES_DOBLES, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_PILAS = async () => {
    return await (await fetch(SEED.ESTRUCTURAS_LINEALES.PILAS, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_COLAS = async () => {
    return await (await fetch(SEED.ESTRUCTURAS_LINEALES.COLAS, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_COLASP = async () => {
    return await (await fetch(SEED.ESTRUCTURAS_LINEALES.COLAS_PRIORITARIAS, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_HASH = async () => {
    return await (await fetch(SEED.ESTRUCTURAS_LINEALES.HASH, {
        method: "GET",
    })).text();
}
/*----------------------------------------------------- Estructuras Lineales ------------------------------------------------------------------- */
...
export const getAnalisis_AB = async () => {
    return await (await fetch(SEED.ARBOLES_BINARIOS.ARBOL_BINARIO, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_ABB = async () => {
    return await (await fetch(SEED.ARBOLES_BINARIOS.ARBOL_BINARIO_BUSQUEDA, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_AVL = async () => {
    return await (await fetch(SEED.ARBOLES_BINARIOS.ARBOL_AVL, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_ARN = async () => {
    return await (await fetch(SEED.ARBOLES_BINARIOS.ARBOL_ROJO_NEGRO, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_ASPLAY = async () => {
    return await (await fetch(SEED.ARBOLES_BINARIOS.ARBOL_SPLAY, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_AHEAP = async () => {
    return await (await fetch(SEED.ARBOLES_BINARIOS.ARBOL_HEAP, {
        method: "GET",
    })).text();
}
/*----------------------------------------------------- Arboles Binarios ------------------------------------------------------------------- */
...
export const getAnalisis_AE = async () => {
    return await (await fetch(SEED.ARBOLES_ENEARIOS.ARBOL_ENEARIO, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_DIGRAFO = async () => {
    return await (await fetch(SEED.ARBOLES_ENEARIOS.DIGRAFO, {
        method: "GET",
    })).text();
}
...
export const getAnalisis_G_D_ND = async () => {
    return await (await fetch(SEED.ARBOLES_ENEARIOS.GRAFO_D_ND, {
        method: "GET",
    })).text();
}
/*----------------------------------------------------- Arboles Enearios ------------------------------------------------------------------- */